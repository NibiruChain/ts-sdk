...
export const EventUpdateSudoers = {
  encode(message: EventUpdateSudoers, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  create<I extends Exact<DeepPartial<EventUpdateSudoers>, I>>(base?: I): EventUpdateSudoers {
    return EventUpdateSudoers.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<EventUpdateSudoers>, I>>(object: I): EventUpdateSudoers {
    const message = createBaseEventUpdateSudoers();
