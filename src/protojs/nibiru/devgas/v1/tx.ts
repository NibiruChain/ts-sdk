...
export const MsgRegisterFeeShare = {
  ...
  create<I extends Exact<DeepPartial<MsgRegisterFeeShare>, I>>(base?: I): MsgRegisterFeeShare {
    return MsgRegisterFeeShare.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgRegisterFeeShare>, I>>(object: I): MsgRegisterFeeShare {
    const message = createBaseMsgRegisterFeeShare();
...
export const MsgRegisterFeeShareResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgRegisterFeeShareResponse>, I>>(base?: I): MsgRegisterFeeShareResponse {
    return MsgRegisterFeeShareResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgRegisterFeeShareResponse>, I>>(_: I): MsgRegisterFeeShareResponse {
    const message = createBaseMsgRegisterFeeShareResponse();
    return message;
  },
};
...
export const MsgUpdateFeeShare = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateFeeShare>, I>>(base?: I): MsgUpdateFeeShare {
    return MsgUpdateFeeShare.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgUpdateFeeShare>, I>>(object: I): MsgUpdateFeeShare {
    const message = createBaseMsgUpdateFeeShare();
    message.contractAddress = object.contractAddress ?? "";
    message.deployerAddress = object.deployerAddress ?? "";
    message.withdrawerAddress = object.withdrawerAddress ?? "";
...
export const MsgUpdateFeeShareResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgUpdateFeeShareResponse>, I>>(base?: I): MsgUpdateFeeShareResponse {
    return MsgUpdateFeeShareResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgUpdateFeeShareResponse>, I>>(_: I): MsgUpdateFeeShareResponse {
    const message = createBaseMsgUpdateFeeShareResponse();
    return message;
  },
};
...
export const MsgCancelFeeShare = {
  ...
  create<I extends Exact<DeepPartial<MsgCancelFeeShare>, I>>(base?: I): MsgCancelFeeShare {
    return MsgCancelFeeShare.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgCancelFeeShare>, I>>(object: I): MsgCancelFeeShare {
    const message = createBaseMsgCancelFeeShare();
    message.contractAddress = object.contractAddress ?? "";
    message.deployerAddress = object.deployerAddress ?? "";
    return message;
...
export const MsgCancelFeeShareResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgCancelFeeShareResponse>, I>>(base?: I): MsgCancelFeeShareResponse {
    return MsgCancelFeeShareResponse.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MsgCancelFeeShareResponse>, I>>(_: I): MsgCancelFeeShareResponse {
    const message = createBaseMsgCancelFeeShareResponse();
    return message;
  },
};
...
export class MsgClientImpl implements Msg {
  ...
  RegisterFeeShare(request: MsgRegisterFeeShare): Promise<MsgRegisterFeeShareResponse> {
    ...
    return promise.then((data) => MsgRegisterFeeShareResponse.decode(_m0.Reader.create(data)));
  }

  UpdateFeeShare(request: MsgUpdateFeeShare): Promise<MsgUpdateFeeShareResponse> {
    const data = MsgUpdateFeeShare.encode(request).finish();
    const promise = this.rpc.request(this.service, "UpdateFeeShare", data);
    return promise.then((data) => MsgUpdateFeeShareResponse.decode(_m0.Reader.create(data)));
  }

  CancelFeeShare(request: MsgCancelFeeShare): Promise<MsgCancelFeeShareResponse> {
    const data = MsgCancelFeeShare.encode(request).finish();
    const promise = this.rpc.request(this.service, "CancelFeeShare", data);
    return promise.then((data) => MsgCancelFeeShareResponse.decode(_m0.Reader.create(data)));
  }
