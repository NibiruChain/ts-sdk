 ...
 *
 * EVM code should look up plugins by name instead of hard-coding Wasm contract
 * addresses. For example, plugin name "x-oracle" can identify the Wasm adapter
 * used by the legacy oracle precompile at
...
function createBaseParams(): Params {
  return { extraEips: [], evmChannels: [], createFuntokenFee: "", canonicalWnibi: "", wasmPlugins: [] };
}
...
export const Params = {
  encode(message: Params, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.wasmPlugins) {
      WasmPlugin.encode(v!, writer.uint32(90).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.wasmPlugins.push(WasmPlugin.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Params {
    return {
      ...
      wasmPlugins: Array.isArray(object?.wasmPlugins) ? object.wasmPlugins.map((e: any) => WasmPlugin.fromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.wasmPlugins) {
      obj.wasmPlugins = message.wasmPlugins.map((e) => e ? WasmPlugin.toJSON(e) : undefined);
    } else {
      obj.wasmPlugins = [];
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.wasmPlugins = object.wasmPlugins?.map((e) => WasmPlugin.fromPartial(e)) || [];
    return message;
  },
};

function createBaseWasmPlugin(): WasmPlugin {
  return { name: "", addr: "" };
}

export const WasmPlugin = {
  encode(message: WasmPlugin, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.name !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): WasmPlugin {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseWasmPlugin();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): WasmPlugin {
    return { name: isSet(object.name) ? String(object.name) : "", addr: isSet(object.addr) ? String(object.addr) : "" };
  },

  toJSON(message: WasmPlugin): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<WasmPlugin>, I>>(base?: I): WasmPlugin {
    return WasmPlugin.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<WasmPlugin>, I>>(object: I): WasmPlugin {
    const message = createBaseWasmPlugin();
...
function createBaseLogLite(): LogLite {
  return { address: "", topics: [], data: new Uint8Array(0) };
}

export const LogLite = {
  encode(message: LogLite, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.address !== "") {
      writer.uint32(10).string(message.address);
    }
    for (const v of message.topics) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): LogLite {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLogLite();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: LogLite): unknown {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
    if (message.topics) {
      obj.topics = message.topics.map((e) => e);
  ...
  create<I extends Exact<DeepPartial<LogLite>, I>>(base?: I): LogLite {
    return LogLite.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<LogLite>, I>>(object: I): LogLite {
    const message = createBaseLogLite();
    message.address = object.address ?? "";
    message.topics = object.topics?.map((e) => e) || [];
    message.data = object.data ?? new Uint8Array(0);
