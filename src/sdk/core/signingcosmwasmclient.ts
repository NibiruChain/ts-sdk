...
import { NibiCosmWasmClient, NibiCosmWasmClientOptions } from "./cosmwasmclient"
...
export interface NibiSigningCosmWasmClientOptions
  extends NibiCosmWasmClientOptions {
...
type FeeOption = StdFee | "auto" | number

export class NibiSigningCosmWasmClient extends NibiCosmWasmClient {
  ...
  public static async connectWithSigner(
    ...
    options: NibiSigningCosmWasmClientOptions = {}
  ): Promise<NibiSigningCosmWasmClient> {
    const cometClient = await connectComet(endpoint)
    return NibiSigningCosmWasmClient.createWithSigner(
      cometClient,
      signer,
      options
    )
  ...
  public static async createWithSigner(
    ...
    return new NibiSigningCosmWasmClient(cometClient, signer, options)
  }
  ...
  public static async offline(
    ...
    return new NibiSigningCosmWasmClient(undefined, signer, options)
  }
