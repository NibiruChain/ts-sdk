...
function createBaseCreatePoolProposal(): CreatePoolProposal {
  return { title: "", description: "", pair: "", quoteAssetReserve: "", baseAssetReserve: "", config: undefined };
}
...
export const EditPoolConfigProposal = {
  encode(message: EditPoolConfigProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
...
export const EditSwapInvariantsProposal = {
  encode(message: EditSwapInvariantsProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
    ...
    for (const v of message.swapInvariantMaps) {
      EditSwapInvariantsProposal_SwapInvariantMultiple.encode(v!, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): EditSwapInvariantsProposal {
    return {
      ...
      swapInvariantMaps: Array.isArray(object?.swapInvariantMaps)
        ? object.swapInvariantMaps.map((e: any) => EditSwapInvariantsProposal_SwapInvariantMultiple.fromJSON(e))
        : [],
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EditSwapInvariantsProposal>, I>>(object: I): EditSwapInvariantsProposal {
    ...
    message.swapInvariantMaps =
      object.swapInvariantMaps?.map((e) => EditSwapInvariantsProposal_SwapInvariantMultiple.fromPartial(e)) || [];
    return message;
  },
};
