...
export const ReserveSnapshotSavedEvent = {
  encode(
    ...
    if (message.blockTimestamp !== undefined) {
      Timestamp.encode(
        toTimestamp(message.blockTimestamp),
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break
        case 6:
          message.blockTimestamp = fromTimestamp(
...
export const SwapOnVpoolEvent = {
  ...
  fromPartial<I extends Exact<DeepPartial<SwapOnVpoolEvent>, I>>(
    object: I,
  ): SwapOnVpoolEvent {
    const message = createBaseSwapOnVpoolEvent()
    message.pair = object.pair ?? ""
...
export const MarkPriceChangedEvent = {
  ...
  fromPartial<I extends Exact<DeepPartial<MarkPriceChangedEvent>, I>>(
    object: I,
