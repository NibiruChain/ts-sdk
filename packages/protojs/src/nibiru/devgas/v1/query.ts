...
export const QueryFeeSharesRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryFeeSharesRequest>, I>>(
    base?: I
  ): QueryFeeSharesRequest {
    return QueryFeeSharesRequest.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<QueryFeeSharesRequest>, I>>(
    object: I
  ): QueryFeeSharesRequest {
    const message = createBaseQueryFeeSharesRequest()
...
export const QueryFeeSharesResponse = {
  ...
  fromJSON(object: any): QueryFeeSharesResponse {
    return {
      feeshare: Array.isArray(object?.feeshare)
        ? object.feeshare.map((e: any) => FeeShare.fromJSON(e))
        : [],
    }
  },
  ...
  toJSON(message: QueryFeeSharesResponse): unknown {
    const obj: any = {}
    if (message.feeshare) {
      obj.feeshare = message.feeshare.map((e) =>
        e ? FeeShare.toJSON(e) : undefined
      )
    } else {
      obj.feeshare = []
    }
  ...
  create<I extends Exact<DeepPartial<QueryFeeSharesResponse>, I>>(
    base?: I
  ): QueryFeeSharesResponse {
    return QueryFeeSharesResponse.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<QueryFeeSharesResponse>, I>>(
    object: I
  ): QueryFeeSharesResponse {
    const message = createBaseQueryFeeSharesResponse()
    message.feeshare =
      object.feeshare?.map((e) => FeeShare.fromPartial(e)) || []
    return message
  },
}
...
export const QueryFeeShareRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryFeeShareRequest>, I>>(
    base?: I
  ): QueryFeeShareRequest {
    return QueryFeeShareRequest.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<QueryFeeShareRequest>, I>>(
    object: I
  ): QueryFeeShareRequest {
    const message = createBaseQueryFeeShareRequest()
...
export const QueryFeeShareResponse = {
  ...
  fromJSON(object: any): QueryFeeShareResponse {
    return {
      feeshare: isSet(object.feeshare)
        ? FeeShare.fromJSON(object.feeshare)
        : undefined,
    }
  },
  ...
  toJSON(message: QueryFeeShareResponse): unknown {
    ...
    message.feeshare !== undefined &&
      (obj.feeshare = message.feeshare
        ? FeeShare.toJSON(message.feeshare)
        : undefined)
    return obj
  },

  create<I extends Exact<DeepPartial<QueryFeeShareResponse>, I>>(
    base?: I
  ): QueryFeeShareResponse {
    return QueryFeeShareResponse.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<QueryFeeShareResponse>, I>>(
    object: I
  ): QueryFeeShareResponse {
    const message = createBaseQueryFeeShareResponse()
    message.feeshare =
      object.feeshare !== undefined && object.feeshare !== null
...
export const QueryFeeSharesByWithdrawerRequest = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryFeeSharesByWithdrawerRequest>, I>
  >(object: I): QueryFeeSharesByWithdrawerRequest {
    const message = createBaseQueryFeeSharesByWithdrawerRequest()
...
export const QueryFeeSharesByWithdrawerResponse = {
  ...
  fromPartial<
    I extends Exact<DeepPartial<QueryFeeSharesByWithdrawerResponse>, I>
  >(object: I): QueryFeeSharesByWithdrawerResponse {
    const message = createBaseQueryFeeSharesByWithdrawerResponse()
    message.feeshare =
      object.feeshare?.map((e) => FeeShare.fromPartial(e)) || []
    return message
...
export class QueryClientImpl implements Query {
  ...
  FeeShares(request: QueryFeeSharesRequest): Promise<QueryFeeSharesResponse> {
    ...
    return promise.then((data) =>
      QueryFeeSharesResponse.decode(_m0.Reader.create(data))
    )
  }
  ...
  FeeShare(request: QueryFeeShareRequest): Promise<QueryFeeShareResponse> {
    ...
    return promise.then((data) =>
      QueryFeeShareResponse.decode(_m0.Reader.create(data))
    )
  }
  ...
  FeeSharesByWithdrawer(
    ...
    return promise.then((data) =>
      QueryFeeSharesByWithdrawerResponse.decode(_m0.Reader.create(data))
    )
  }
}
