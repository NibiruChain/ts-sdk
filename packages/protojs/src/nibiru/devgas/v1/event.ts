...
export const EventRegisterDevGas = {
  ...
  create<I extends Exact<DeepPartial<EventRegisterDevGas>, I>>(
    base?: I
  ): EventRegisterDevGas {
    return EventRegisterDevGas.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<EventRegisterDevGas>, I>>(
    object: I
  ): EventRegisterDevGas {
    const message = createBaseEventRegisterDevGas()
...
export const EventCancelDevGas = {
  ...
  create<I extends Exact<DeepPartial<EventCancelDevGas>, I>>(
    base?: I
  ): EventCancelDevGas {
    return EventCancelDevGas.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<EventCancelDevGas>, I>>(
    object: I
  ): EventCancelDevGas {
    const message = createBaseEventCancelDevGas()
    message.deployer = object.deployer ?? ""
...
export const EventUpdateDevGas = {
  ...
  create<I extends Exact<DeepPartial<EventUpdateDevGas>, I>>(
    base?: I
  ): EventUpdateDevGas {
    return EventUpdateDevGas.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<EventUpdateDevGas>, I>>(
    object: I
  ): EventUpdateDevGas {
    const message = createBaseEventUpdateDevGas()
    message.deployer = object.deployer ?? ""
...
export const EventPayoutDevGas = {
  ...
  create<I extends Exact<DeepPartial<EventPayoutDevGas>, I>>(
    base?: I
  ): EventPayoutDevGas {
    return EventPayoutDevGas.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<EventPayoutDevGas>, I>>(
    object: I
  ): EventPayoutDevGas {
    const message = createBaseEventPayoutDevGas()
