...
export const ModuleParams = {
  ...
  fromJSON(object: any): ModuleParams {
    return {
      enableFeeShare: isSet(object.enableFeeShare)
        ? Boolean(object.enableFeeShare)
        : false,
      developerShares: isSet(object.developerShares)
        ? String(object.developerShares)
        : "",
  ...
  toJSON(message: ModuleParams): unknown {
    const obj: any = {}
    message.enableFeeShare !== undefined &&
      (obj.enableFeeShare = message.enableFeeShare)
    message.developerShares !== undefined &&
      (obj.developerShares = message.developerShares)
