...
export interface OraclePriceUpdate {
  $type: "nibiru.oracle.v1.OraclePriceUpdate"
  pair: string
  price: string
  timestampMs: Long
}
...
export const OraclePriceUpdate = {
  $type: "nibiru.oracle.v1.OraclePriceUpdate" as const,
  ...
  create<I extends Exact<DeepPartial<OraclePriceUpdate>, I>>(
    base?: I,
  ): OraclePriceUpdate {
    return OraclePriceUpdate.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<OraclePriceUpdate>, I>>(
    object: I,
  ): OraclePriceUpdate {
    const message = createBaseOraclePriceUpdate()
...
messageTypeRegistry.set(OraclePriceUpdate.$type, OraclePriceUpdate)
