  ...
  fromJSON(object: any): MsgEditOracleParams {
    return {
      ...
      params: isSet(object.params)
        ? OracleParamsMsg.fromJSON(object.params)
        : undefined,
    }
  },
  ...
  toJSON(message: MsgEditOracleParams): unknown {
    ...
    message.params !== undefined &&
      (obj.params = message.params
        ? OracleParamsMsg.toJSON(message.params)
        : undefined)
    return obj
  },

  create<I extends Exact<DeepPartial<MsgEditOracleParams>, I>>(
    base?: I
  ): MsgEditOracleParams {
    return MsgEditOracleParams.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<MsgEditOracleParams>, I>>(
    object: I
  ): MsgEditOracleParams {
    const message = createBaseMsgEditOracleParams()
...
export const MsgEditOracleParamsResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgEditOracleParamsResponse>, I>>(
    base?: I
  ): MsgEditOracleParamsResponse {
    return MsgEditOracleParamsResponse.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<MsgEditOracleParamsResponse>, I>>(
    _: I
  ): MsgEditOracleParamsResponse {
    const message = createBaseMsgEditOracleParamsResponse()
    return message
...
export const OracleParamsMsg = {
  ...
  create<I extends Exact<DeepPartial<OracleParamsMsg>, I>>(
    base?: I
  ): OracleParamsMsg {
    return OracleParamsMsg.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<OracleParamsMsg>, I>>(
    object: I
  ): OracleParamsMsg {
    const message = createBaseOracleParamsMsg()
    message.votePeriod =
...
export class MsgClientImpl implements Msg {
  ...
  EditOracleParams(
    ...
    return promise.then((data) =>
      MsgEditOracleParamsResponse.decode(_m0.Reader.create(data))
    )
  }
}
