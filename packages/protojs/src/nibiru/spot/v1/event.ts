...
function createBaseEventPoolCreated(): EventPoolCreated {
  return { creator: "", fees: [], finalPool: undefined, finalUserPoolShares: undefined };
}
...
export const EventPoolCreated = {
  ...
  fromJSON(object: any): EventPoolCreated {
    return {
      ...
      finalUserPoolShares: isSet(object.finalUserPoolShares) ? Coin.fromJSON(object.finalUserPoolShares) : undefined,
    };
  },
  ...
  toJSON(message: EventPoolCreated): unknown {
    ...
    message.finalPool !== undefined && (obj.finalPool = message.finalPool ? Pool.toJSON(message.finalPool) : undefined);
    message.finalUserPoolShares !== undefined &&
      (obj.finalUserPoolShares = message.finalUserPoolShares ? Coin.toJSON(message.finalUserPoolShares) : undefined);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EventPoolCreated>, I>>(object: I): EventPoolCreated {
    ...
    message.finalPool = (object.finalPool !== undefined && object.finalPool !== null)
      ? Pool.fromPartial(object.finalPool)
      : undefined;
    message.finalUserPoolShares = (object.finalUserPoolShares !== undefined && object.finalUserPoolShares !== null)
...
function createBaseEventAssetsSwapped(): EventAssetsSwapped {
  return { address: "", tokenIn: undefined, tokenOut: undefined, fee: undefined, finalPool: undefined };
}
