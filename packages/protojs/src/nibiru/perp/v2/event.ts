...
export const PositionChangedEvent = {
  ...
  fromJSON(object: any): PositionChangedEvent {
    return {
      finalPosition: isSet(object.finalPosition) ? Position.fromJSON(object.finalPosition) : undefined,
  ...
  toJSON(message: PositionChangedEvent): unknown {
    ...
    message.finalPosition !== undefined &&
      (obj.finalPosition = message.finalPosition ? Position.toJSON(message.finalPosition) : undefined);
...
export const PositionLiquidatedEvent = {
  encode(message: PositionLiquidatedEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.positionChangedEvent !== undefined) {
      PositionChangedEvent.encode(message.positionChangedEvent, writer.uint32(10).fork()).ldelim();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.positionChangedEvent = PositionChangedEvent.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  toJSON(message: PositionLiquidatedEvent): unknown {
    const obj: any = {};
    message.positionChangedEvent !== undefined && (obj.positionChangedEvent = message.positionChangedEvent
  ...
  fromPartial<I extends Exact<DeepPartial<PositionLiquidatedEvent>, I>>(object: I): PositionLiquidatedEvent {
    const message = createBasePositionLiquidatedEvent();
    message.positionChangedEvent = (object.positionChangedEvent !== undefined && object.positionChangedEvent !== null)
...
function createBaseFundingRateChangedEvent(): FundingRateChangedEvent {
  return { pair: "", markPriceTwap: "", indexPriceTwap: "", premiumFraction: "", cumulativePremiumFraction: "" };
}
...
export const FundingRateChangedEvent = {
  ...
  fromJSON(object: any): FundingRateChangedEvent {
    return {
      ...
      premiumFraction: isSet(object.premiumFraction) ? String(object.premiumFraction) : "",
  ...
  toJSON(message: FundingRateChangedEvent): unknown {
    ...
    message.indexPriceTwap !== undefined && (obj.indexPriceTwap = message.indexPriceTwap);
    message.premiumFraction !== undefined && (obj.premiumFraction = message.premiumFraction);
...
export const AmmUpdatedEvent = {
  encode(message: AmmUpdatedEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  toJSON(message: AmmUpdatedEvent): unknown {
    const obj: any = {};
    message.finalAmm !== undefined && (obj.finalAmm = message.finalAmm ? AMM.toJSON(message.finalAmm) : undefined);
    message.markPriceTwap !== undefined && (obj.markPriceTwap = message.markPriceTwap);
    message.indexPriceTwap !== undefined && (obj.indexPriceTwap = message.indexPriceTwap);
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<AmmUpdatedEvent>, I>>(object: I): AmmUpdatedEvent {
    const message = createBaseAmmUpdatedEvent();
    message.finalAmm = (object.finalAmm !== undefined && object.finalAmm !== null)
...
export const MarketUpdatedEvent = {
  encode(message: MarketUpdatedEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromJSON(object: any): MarketUpdatedEvent {
    return { finalMarket: isSet(object.finalMarket) ? Market.fromJSON(object.finalMarket) : undefined };
  },

  toJSON(message: MarketUpdatedEvent): unknown {
    const obj: any = {};
    message.finalMarket !== undefined &&
      (obj.finalMarket = message.finalMarket ? Market.toJSON(message.finalMarket) : undefined);
    return obj;
  },

  create<I extends Exact<DeepPartial<MarketUpdatedEvent>, I>>(base?: I): MarketUpdatedEvent {
    return MarketUpdatedEvent.fromPartial(base ?? {});
  },

  fromPartial<I extends Exact<DeepPartial<MarketUpdatedEvent>, I>>(object: I): MarketUpdatedEvent {
    const message = createBaseMarketUpdatedEvent();
    message.finalMarket = (object.finalMarket !== undefined && object.finalMarket !== null)
