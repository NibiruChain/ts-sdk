...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      amms: Array.isArray(object?.amms) ? object.amms.map((e: any) => AMM.fromJSON(e)) : [],
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.reserveSnapshots) {
      obj.reserveSnapshots = message.reserveSnapshots.map((e) => e ? ReserveSnapshot.toJSON(e) : undefined);
    } else {
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(object: I): GenesisState {
    ...
    message.reserveSnapshots = object.reserveSnapshots?.map((e) => ReserveSnapshot.fromPartial(e)) || [];
    return message;
  },
};
