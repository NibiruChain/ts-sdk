...
export const Params = {
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    const message = createBaseParams();
    message.collRatio = (object.collRatio !== undefined && object.collRatio !== null)
      ? Long.fromValue(object.collRatio)
      : Long.ZERO;
    message.feeRatio = (object.feeRatio !== undefined && object.feeRatio !== null)
      ? Long.fromValue(object.feeRatio)
      : Long.ZERO;
    message.efFeeRatio = (object.efFeeRatio !== undefined && object.efFeeRatio !== null)
      ? Long.fromValue(object.efFeeRatio)
      : Long.ZERO;
    message.bonusRateRecoll = (object.bonusRateRecoll !== undefined && object.bonusRateRecoll !== null)
      ? Long.fromValue(object.bonusRateRecoll)
      : Long.ZERO;
    message.distrEpochIdentifier = object.distrEpochIdentifier ?? "";
    message.adjustmentStep = (object.adjustmentStep !== undefined && object.adjustmentStep !== null)
      ? Long.fromValue(object.adjustmentStep)
      : Long.ZERO;
    message.priceLowerBound = (object.priceLowerBound !== undefined && object.priceLowerBound !== null)
      ? Long.fromValue(object.priceLowerBound)
      : Long.ZERO;
    message.priceUpperBound = (object.priceUpperBound !== undefined && object.priceUpperBound !== null)
