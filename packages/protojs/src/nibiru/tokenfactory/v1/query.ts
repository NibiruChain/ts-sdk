...
export const QueryDenomsRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryDenomsRequest>, I>>(
    base?: I
  ): QueryDenomsRequest {
...
export const QueryDenomsResponse = {
  ...
  create<I extends Exact<DeepPartial<QueryDenomsResponse>, I>>(
    base?: I
  ): QueryDenomsResponse {
...
export const QueryDenomInfoRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryDenomInfoRequest>, I>>(
    base?: I
  ): QueryDenomInfoRequest {
    return QueryDenomInfoRequest.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<QueryDenomInfoRequest>, I>>(
    object: I
  ): QueryDenomInfoRequest {
    const message = createBaseQueryDenomInfoRequest()
...
export const QueryDenomInfoResponse = {
  ...
  create<I extends Exact<DeepPartial<QueryDenomInfoResponse>, I>>(
    base?: I
  ): QueryDenomInfoResponse {
    return QueryDenomInfoResponse.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<QueryDenomInfoResponse>, I>>(
    object: I
  ): QueryDenomInfoResponse {
    const message = createBaseQueryDenomInfoResponse()
...
export class QueryClientImpl implements Query {
  ...
  Denoms(request: QueryDenomsRequest): Promise<QueryDenomsResponse> {
    ...
    return promise.then((data) =>
      QueryDenomsResponse.decode(_m0.Reader.create(data))
    )
  }
  ...
  DenomInfo(request: QueryDenomInfoRequest): Promise<QueryDenomInfoResponse> {
    ...
    return promise.then((data) =>
      QueryDenomInfoResponse.decode(_m0.Reader.create(data))
    )
  }
}
