...
export const EventCreateDenom = {
  ...
  create<I extends Exact<DeepPartial<EventCreateDenom>, I>>(
    base?: I
  ): EventCreateDenom {
...
export const EventChangeAdmin = {
  ...
  create<I extends Exact<DeepPartial<EventChangeAdmin>, I>>(
    base?: I
  ): EventChangeAdmin {
    return EventChangeAdmin.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<EventChangeAdmin>, I>>(
    object: I
  ): EventChangeAdmin {
    const message = createBaseEventChangeAdmin()
    message.denom = object.denom ?? ""
...
export const EventSetDenomMetadata = {
  ...
  create<I extends Exact<DeepPartial<EventSetDenomMetadata>, I>>(
    base?: I
  ): EventSetDenomMetadata {
    return EventSetDenomMetadata.fromPartial(base ?? {})
  },

  fromPartial<I extends Exact<DeepPartial<EventSetDenomMetadata>, I>>(
    object: I
  ): EventSetDenomMetadata {
    const message = createBaseEventSetDenomMetadata()
    message.denom = object.denom ?? ""
