...
export class QueryClientImpl implements Query {
  ...
  ExchangeRate(request: QueryExchangeRateRequest): Promise<QueryExchangeRateResponse> {
    ...
    const promise = this.rpc.request(
      "nibiru.oracle.v1beta1.Query",
      "ExchangeRate",
      data,
    )
    return promise.then((data) =>
      QueryExchangeRateResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  ExchangeRates(
    ...
    return promise.then((data) =>
      QueryExchangeRatesResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  FeederDelegation(
    ...
    return promise.then((data) =>
      QueryFeederDelegationResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  AggregatePrevote(
    ...
    return promise.then((data) =>
      QueryAggregatePrevoteResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  AggregatePrevotes(
    ...
    return promise.then((data) =>
      QueryAggregatePrevotesResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  AggregateVote(
    ...
    return promise.then((data) =>
      QueryAggregateVoteResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  AggregateVotes(
    ...
    return promise.then((data) =>
      QueryAggregateVotesResponse.decode(new _m0.Reader(data)),
    )
  }
