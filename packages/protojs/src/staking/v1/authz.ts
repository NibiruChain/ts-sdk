...
export declare const StakeAuthorization: {
    ...
    fromPartial<I extends {
        ...
        allowList?: ({
            ...
            address?: (string[] & string[] & Record<Exclude<keyof I["allowList"]["address"], number | keyof string[]>, never>) | undefined;
        } & Record<Exclude<keyof I["allowList"], "address">, never>) | undefined;
        denyList?: ({
            address?: string[] | undefined;
        } & {
            address?: (string[] & string[] & Record<Exclude<keyof I["denyList"]["address"], number | keyof string[]>, never>) | undefined;
...
export declare const StakeAuthorization_Validators: {
    ...
    fromPartial<I extends {
        ...
        address?: (string[] & string[] & Record<Exclude<keyof I["address"], number | keyof string[]>, never>) | undefined;
