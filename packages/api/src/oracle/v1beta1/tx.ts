...
export class MsgClientImpl implements Msg {
  ...
  AggregateExchangeRatePrevote(
    ...
    const promise = this.rpc.request(
      "nibiru.oracle.v1beta1.Msg",
      "AggregateExchangeRatePrevote",
      data,
    )
    return promise.then((data) =>
      MsgAggregateExchangeRatePrevoteResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  AggregateExchangeRateVote(
    ...
    return promise.then((data) =>
      MsgAggregateExchangeRateVoteResponse.decode(new _m0.Reader(data)),
    )
  }
  ...
  DelegateFeedConsent(
    ...
    return promise.then((data) =>
      MsgDelegateFeedConsentResponse.decode(new _m0.Reader(data)),
    )
  }
}
