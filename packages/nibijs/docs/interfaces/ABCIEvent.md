[NibiJS Documentation - v0.21.43](../intro.md) / [Exports](../modules.md) / ABCIEvent
...
[tx/event.ts:23](https://github.com/NibiruChain/ts-sdk/blob/6e650cb/packages/nibijs/src/tx/event.ts#L23)
...
[tx/event.ts:22](https://github.com/NibiruChain/ts-sdk/blob/6e650cb/packages/nibijs/src/tx/event.ts#L22)
