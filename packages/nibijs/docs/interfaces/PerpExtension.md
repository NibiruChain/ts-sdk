[NibiJS Documentation - v0.21.11](../intro.md) / [Exports](../modules.md) / PerpExtension
...
[query/perp.ts:24](https://github.com/NibiruChain/ts-sdk/blob/1aeb2e3/packages/nibijs/src/query/perp.ts#L24)
