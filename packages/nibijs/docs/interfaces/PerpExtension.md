[NibiJS Documentation - v0.21.37](../intro.md) / [Exports](../modules.md) / PerpExtension
...
[query/perp.ts:24](https://github.com/NibiruChain/ts-sdk/blob/6e5ea8f/packages/nibijs/src/query/perp.ts#L24)
