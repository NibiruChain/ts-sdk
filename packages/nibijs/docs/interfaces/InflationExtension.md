[NibiJS Documentation - v0.21.24](../intro.md) / [Exports](../modules.md) / InflationExtension
...
[query/inflation.ts:19](https://github.com/NibiruChain/ts-sdk/blob/3ca59b8/packages/nibijs/src/query/inflation.ts#L19)
