[NibiJS Documentation - v0.21.44](../intro.md) / [Exports](../modules.md) / EventMap
...
[tx/event.ts:41](https://github.com/NibiruChain/ts-sdk/blob/e2ebd40/packages/nibijs/src/tx/event.ts#L41)
