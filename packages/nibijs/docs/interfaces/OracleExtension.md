[NibiJS Documentation - v0.21.19](../intro.md) / [Exports](../modules.md) / OracleExtension
...
[query/oracle.ts:37](https://github.com/NibiruChain/ts-sdk/blob/9d6af39/packages/nibijs/src/query/oracle.ts#L37)
