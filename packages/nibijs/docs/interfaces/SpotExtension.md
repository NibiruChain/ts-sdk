[NibiJS Documentation - v0.21.14](../intro.md) / [Exports](../modules.md) / SpotExtension
...
[query/spot.ts:57](https://github.com/NibiruChain/ts-sdk/blob/df510f8/packages/nibijs/src/query/spot.ts#L57)
