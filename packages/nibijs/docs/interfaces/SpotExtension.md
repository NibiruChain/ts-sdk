[NibiJS Documentation - v0.21.37](../intro.md) / [Exports](../modules.md) / SpotExtension
...
[query/spot.ts:58](https://github.com/NibiruChain/ts-sdk/blob/6e5ea8f/packages/nibijs/src/query/spot.ts#L58)
