[NibiJS Documentation - v0.21.43](../intro.md) / [Exports](../modules.md) / SpotExtension
...
[query/spot.ts:58](https://github.com/NibiruChain/ts-sdk/blob/cacf9b9/packages/nibijs/src/query/spot.ts#L58)
