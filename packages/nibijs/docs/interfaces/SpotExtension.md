[NibiJS Documentation - v0.21.44](../intro.md) / [Exports](../modules.md) / SpotExtension
...
[query/spot.ts:58](https://github.com/NibiruChain/ts-sdk/blob/e2ebd40/packages/nibijs/src/query/spot.ts#L58)
