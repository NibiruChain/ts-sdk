[NibiJS Documentation - v0.21.28](../intro.md) / [Exports](../modules.md) / SpotExtension
...
[query/spot.ts:57](https://github.com/NibiruChain/ts-sdk/blob/83f95d4/packages/nibijs/src/query/spot.ts#L57)
