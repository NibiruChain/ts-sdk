[NibiJS Documentation - v0.21.45](../intro.md) / [Exports](../modules.md) / SpotExtension
...
[src/query/spot.ts:58](https://github.com/NibiruChain/ts-sdk/blob/c5e4f87/packages/nibijs/src/query/spot.ts#L58)
